// === Discrete Mathematics - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('discrete-math-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('discrete-math-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
